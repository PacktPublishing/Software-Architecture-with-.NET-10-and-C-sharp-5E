        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PurchaseTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ExtractionTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Cost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_Location",
                table: "Purchases",
                column: "Location");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_PurchaseTime",
                table: "Purchases",
                column: "PurchaseTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueItems_ExtractionTime",
                table: "QueueItems",
